...
An heeres how observation space was defined in codeee:
ObservationModule.py
```
"""
...
```
Proposee how we could design the observation space for brass including all feature vecotrs considerign the following statistics. Focus on the board state now. How do we represent the following as vectors. 
Board State 

Build Locations - 76 of 5 industry types
Link Locations - 39 
TradePosts - 3 possible locations with one with 1 slot for Merchant Tiels, 2 with two


(for 2 player game 3)
3 vectors of 5 
for each trade post 
goods in shrewbery  [1, 0, 0, 0, 0]
BOX IN gLAUCESTER 
[0, 1, 0, 0, 0]
	
HOUSE IN GLAUCESTER
	[0, 0, 1, 0, 0]
Beer Present At TradePosts Vector
[1, 1, 1, 0, 0]
